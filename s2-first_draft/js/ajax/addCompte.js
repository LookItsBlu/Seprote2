        ...
        $.ajax({
            ...
            success: function (code) {
                ...
                if (code == 1) {
                    ...
                    notifType = 'success';
                    message.title = 'Compte créé !';
                    message.body = 'Le compte a été créé avec succès !';
                    $('.addCompte input').val('');
                    updateList();
                } else if (code == 0) {
                    ...
                    message.title = 'Compte déjà existant';
                    message.body = "L'adresse mail entré est déjà utilisé par un autre compte, veuillez en utiliser une autre.";
                } else if (code == -5) {
